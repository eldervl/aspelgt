...
<!--AREA DE CONTENIDO=====================================================-->
    ...
    <section class="contenedor noselect" id="seccion-infogrm">
        ...
        <div class="row">
            <div class="col-lg-6">
                <img src="img/productos/logos-ext/noi.png" alt="none">
                <br>
                <br>
                <p>Aspel NOI automatiza el control de la nómina. Ofrece un cálculo exacto de las percepciones y deducciones de los trabajadores de acuerdo con las disposiciones fiscales y laborales vigentes. Genera Comprobantes Fiscales Digitales por Internet (CFDI 3.3) de los Recibos de Nómina y asimilables a salarios. Genera Comprobantes Fiscales Digitales por Internet (CFDI) de Nómina de los trabajadores ya sea de forma unitaria o masiva y asegura la deducción de la Nómina. </p>
        ...
        <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <h4>Con Aspel NOI la administración de los trabajadores de la empresa es segura y rápida</h4>
                    <p>-Generación automática del RFC, CURP y dígito verificador del Número de Seguridad Social (NSS). <br>
                       -Cálculo automático del Salario Diario Integrado y consulta de su desglose. <br>
                        -Visualiza de manera sencilla la información acerca del salario, puesto, departamento, clasificación y afiliación al IMSS de tus colaboradores. <br>
                 </p>
                </div>
