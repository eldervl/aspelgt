    ...
    <section class="contenedor noselect" id="seccion-infogrm">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <br>
                <br>
                <h2 class="font-weight-bold text-primary">Capacitación Aspel CAJA</h2>
                <p>Aprenderás como agilizar y convertir un equipo de computo en un punto de ventas ademas Visualiza en todo momento el estado de tus comprobantes de forma sencilla e inmediata</p>
                <div class="">
