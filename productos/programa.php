<!--
ASPEL proyect, programa.php v1er
-->
...
<!--AREA DE CONTENIDO=====================================================-->
    ...
    <section class="contenedor noselect" id="seccion-infogrm">
        ...
        <div class="row">
            <div class="col-lg-6">
                <img src="../img/productos/logos-prod/NONE.png" alt="none">
                <br>
                <br>
                <p>Descripcion breve del programa</p>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Acerca del (Nombre del programa)</a>
        ...
        <div class="col-md-9">
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <h2 class="font-weight-bold text-primary">Información de (Nombre del programa)</h2>
                ...
                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    ...
                    <h2 class="font-weight-bold text-primary">(Nombre del programa) Móvil</h2>
