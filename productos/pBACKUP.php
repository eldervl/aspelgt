    ...
    <section class="contenedor noselect" id="seccion-infogrm">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <p>Copia de seguridad de bases de datos MySQL, MariaDB Microsoft SQL Server y servidores Exchange.Se pueden programar copias de seguridad múltiples y paralelas de servidores de bases de datos locales, en red y remotos, sin ninguna interrupción de los servicios (copia de seguridad en caliente)</p>    
            </div>
           <div class="col-lg-6">
        ...
        <div class="col-9">
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <ul>
                    ...
                    <li><i class="ri-check-double-line"></i>compatible con: MySQL versión 3.23 y posterior</li>
